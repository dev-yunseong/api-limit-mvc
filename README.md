# API Rate Limiter for Spring MVC

This library provides a simple way to add API rate limiting to your Spring MVC application. It uses an in-memory storage for tracking request counts.
...
```groovy
dependencies {
    implementation 'dev.yunseong:api-limit-mvc:0.0.1'
}
```
